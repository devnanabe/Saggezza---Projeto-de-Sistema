...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['arquivo']) && isset($_POST['clienteSelect']) && isset($_POST['equipamentoSelect']) && isset($_POST['data'])){
    // Verificar se os dados foram recebidos
        $cliente = $_POST['clienteSelect'];
        $equipamento = $_POST['equipamentoSelect'];
        $data = $_POST['data'];
